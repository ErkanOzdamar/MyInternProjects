...
export default function News() {
  const news = [
    { id: 1, img: "/imagesNews/news1.jpg", title: "Lorem", price: " galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with d" },
    { id: 2, img: "/imagesNews/news2.jpg", title: "Ipsum", price: "₺ galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with d200" },
    { id: 3, img: "/imagesNews/news3.jpg", title: "Lorem", price: " galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with d" },
    { id: 4, img: "/imagesNews/news4.jpg", title: "Ipsum", price: " galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with d" },
  ];
...
return (
  <div className="newsSlider-wrapper">
    ...
    <div className="newsSlider-inner">
      <button className="newNav-btn left" onClick={prevManual}>{"<"}</button>
      <div
      ...
      <button className="newNav-btn right" onClick={nextManual}>{">"}</button>
    </div>
  </div>
);
